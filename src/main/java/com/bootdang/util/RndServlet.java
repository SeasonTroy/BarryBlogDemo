...
public class RndServlet {
    ...
    public void getCode( HttpServletResponse resp) throws IOException {
        ...
        Random r = new Random();
        int bjred = r.nextInt(255);
        int bjgreen = r.nextInt(255);
        int bjblue = r.nextInt(255);
        // 背景颜色
        gd.setColor(new Color(bjred, bjgreen, bjblue));
        ...
        int xtred = r.nextInt(255);
        int xtgreen = r.nextInt(255);
        int xtblue = r.nextInt(255);
        gd.setColor(new Color(xtred, xtgreen, xtblue));
        for (int i = 0; i < 40; i++) {
