...
/**
 * Fired when the end of the media article is reached (currentTime == duration)
 * @event ended
 */
...
/**
 * Fired when the duration of the media article is first known or changed
 ...
 * and for text tracks whose kind is chapters, the user agent is making available to the user a mechanism by which the user can navigate to any point in the media article by selecting a cue.
